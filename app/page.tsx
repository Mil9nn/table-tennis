...
const heading = "tracking-tight font-bold text-neutral-900";
const subtext = "text-neutral-600 leading-relaxed";
const sectionSpacing = "px-6 sm:px-8 py-16 sm:py-24";
...
export default function HomePage() {
  return (
    <div className="flex flex-col">
      ...
      {/* CTA */}
      <section className="px-6 sm:px-8 py-16 sm:py-24 bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-700 text-white">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
