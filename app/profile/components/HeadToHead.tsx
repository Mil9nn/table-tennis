...
const HeadToHead = ({ detailedStats }: HeadToHeadProps) => {
  ...
  return (
    <div className="p-4">
      <h3 className="text-lg font-semibold text-gray-800 mb-4">Head-to-Head</h3>
      <div className="space-y-2">
        {detailedStats.headToHead.map((h: any) => (
          <div key={h.opponent._id} className="flex items-center justify-between p-2 px-4 bg-white shadow-sm rounded-md">
