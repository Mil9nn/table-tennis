...
import { buildDoublesRotationForTeamMatch } from "@/services/match/serverCalculationService";
import { withAuth } from "@/lib/api-utils";
import { canScoreTournamentMatch } from "@/lib/tournament-permissions";
import { applyShotsToLoadedMatch } from "@/services/match/embeddedShotService";
...
export async function POST(
  ...
  try {
    ...
    subMatch.currentServer = serverConfig.firstServer;
