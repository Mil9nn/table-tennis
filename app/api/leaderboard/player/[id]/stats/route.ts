...
import { hydrateTeamMatchesWithPoints } from "@/services/match/embeddedShotService";
...
export async function GET(
  ...
  try {
    ...
    await hydrateTeamMatchesWithPoints(
      teamMatchesForServes as Record<string, unknown>[]
    );
