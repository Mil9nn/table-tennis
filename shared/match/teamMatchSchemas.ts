...
import { FORMAT_REQUIREMENTS, TeamMatchFormat } from "./teamMatchTypes.core";
...
/**
 * Configure custom-format rubbers after the team match is created.
 */
export const configureTeamMatchSubmatchesSchema = z.object({
  customConfig: customMatchConfigSchema,
});
