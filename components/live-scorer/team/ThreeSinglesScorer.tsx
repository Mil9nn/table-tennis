...
import { buildThreeSinglesOrder } from "./helpers";
...
export default function ThreeSinglesScorer({ match }: Props) {
  const {
    matchesWonA,
    matchesWonB,
    isTeamActive,
  ...
  const order = buildThreeSinglesOrder();
      ...
      {status === "completed" ? (
        ...
        <>
          ...
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="text-lg font-semibold">Three Singles Order</h3>
